      ...
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          <div className="flex items-center justify-center">
            <h3 className="my-auto mr-auto text-xl text-green-1000 font-bold shadow-md py-1 px-3 
            rounded-md bg-white bg-opacity-30">Weather forecast app</h3>
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="text-white text-2xl">Search for a city or click the location icon to get your current location forecast</h1>
        ...
        <div className="w-2/4 p-5">
          ...
          <div className="flex flex-col my-10">
            ...
            {weatherData.length === 0 ? 
              ...
              <>
                <h1 className="text-5xl text-gray-800 mt-auto mb-4">Current weather:</h1>
